...
const PrivacyPolicy = () => (
  <>
    ...
    <section
      className="privacy-policy-area section-padding"
      id="privacy-policy"
    >
        ...
        <div className="row">
          <div className="col-sm-8 col-sm-offset-2">
            <div className="title text-center">
              ...
              <p>
                Your privacy is important to us. It is Dream On: Global&#39;s
                ...
                <a href="https://dreamon.world">https://dreamon.world</a>, and
                other sites we own and operate.{' '}
              </p>
              <p>
                This policy is effective as of 29 December 2021 and was last
